...
const COLORS_TOP = ["#2563eb", "#1d4ed8", "#3b82f6", "#60a5fa"];
...
export const AuroraHero: React.FC<AuroraHeroProps> = ({
  ...
  description = "Comprehensive pharmaceutical solutions designed to support healthcare providers and ensure quality medicine reaches every corner of Pakistan. From WHO-GMP certified products to 24/7 emergency support.",
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <motion.button
          ...
          className="group relative flex w-fit items-center gap-1.5 rounded-full bg-gray-950/10 px-6 py-3 text-gray-50 transition-colors hover:bg-gray-950/50 font-semibold"
        >
          {buttonText}
